Paginador = function(divPaginador, tabla)
{
    ...
    this.tamPagina = 6; //el tamaño de la página (filas por página)
    ...
    this.Mostrar = function()
    {
        ...
        ant.innerHTML = '<i class="fa-solid fa-circle-left"></i> Anterior';
        ant.className = 'paginadores'; //con eso le asigno un estilo y una clase al boton
        var self = this;
        ...
        num.className = 'num_paginador';
 
        var sig = fil.insertCell(fil.cells.length);
        sig.innerHTML = 'Siguiente <i class="fa-solid fa-circle-right"></i>';
        sig.className = 'paginadores';
